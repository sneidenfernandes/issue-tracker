...
export default function ProjectOverview({params} : {params: Promise<{projectId: string}>}){
   ...
   const noteList = [
    {
        user: "Alice",
        note: "Completed the initial project setup and documentation.",
        projectId: "proj-001",
        date: "2025-07-07"
    },
    {
        user: "Bob",
        note: "Added authentication logic and tested login functionality.",
        projectId: "proj-002",
        date: "2025-07-06"
    },
    {
        user: "Charlie",
        note: "Fixed bugs in the dashboard and updated the styling.",
        projectId: "proj-003",
        date: "2025-07-05"
    }
]; 
                                ...
                                <div className="flex flex-col">
                                    ...
                                    className={`w-[350px] sm:w-[540px] lg:w-[670px] border-neutral-800 border-[1px] h-[20vh] md:h-[25vh] mt-[10vh] rounded-lg md:mt-5 shadow-sm shadow-black`}>
                                          <div className="h-10 flex justify-between items-center font-light px-3 text-xs md:text-sm ">
                                            ...
                                            <div className={`w-30% space-x-1 flex justify-between text-neutral-400 items-center ${noteList?.length === 0 && "hidden"}`}>
...

                                        {
                                            noteList.length < 1 ? 
                                            (
                                                <div className={`${createNote ? "hidden" : " "} h-[80%] flex justify-center items-center`}>
                                                    <div className="flex flex-col justify-center items-center">
                                                        <button onClick={() => setCreateNote(true)} className="flex space-x-1 items-center px-2 py-1 ease-in-out border-neutral-800 rounded-md mt-2 border-[1px] shadow-sm hover:shadow-lg shadow-black transition-all duration-200">
                                                            <PenIcon/>
                                                            <p className="text-xs text-neutral-400 md:text-md">Write your first note</p>
                                                        </button>
                                                    </div>
                                                </div>
                                            ) : (
