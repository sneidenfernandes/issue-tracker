...
import { ProjectIcon,SidbarToggleIcon,ViewsIcon } from './icons/WorkspaceIcons';
...
const SidebarContent = () => {
  ...
  return (
    <div className={` md:flex z-500 w-63 border-r-[1px] border-r-neutral-800 md:border-r-0 rounded-xl md:rounded-none bg-neutral-950 md:flex-col md:justify-start items-center h-screen fixed md:top-0 ${visible ? "opacity-70": " "}`}>
        <div className='md:w-full px-2 flex text-xs flex-row justify-between text-neutral-400 mt-[2vh] items-center rounded'>
    ...
    return <li>
                <div className={`flex flex-col  ml-1`}>
                    <div className={`flex text-xs scale-0.9  hover:bg-neutral-900 w-[90%] rounded py-2 justify-start`} onClick={()=>setOpen(!open)}>
                        ...
                        <svg className={`mr-3 mt-[2px] transition duration-100 ease-in-out ${open ? "rotate-90" : ""}`} width="12px" height="12px" viewBox="0 0 24 24" strokeWidth="1.4" fill="none" xmlns="http://www.w3.org/2000/svg" color="#a9a9a9"><path fillRule="evenodd" clipRule="evenodd" d="M8.71299 18.6929C8.43273 18.5768 8.25 18.3033 8.25 18V5.99998C8.25 5.69663 8.43273 5.42315 8.71299 5.30707C8.99324 5.19098 9.31583 5.25515 9.53033 5.46965L15.5303 11.4696C15.8232 11.7625 15.8232 12.2374 15.5303 12.5303L9.53033 18.5303C9.31583 18.7448 8.99324 18.809 8.71299 18.6929Z" fill="#a9a9a9"></path></svg>
                    </div>
