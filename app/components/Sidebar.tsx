...
const Sidebar = () => {
    ...
    //     open:{
    //         x: 0,
    //         transition: {type:"spring", stiffness:300, damping:500},
    //     },
    //     closed: {
    //         x: "-100%",
    //         transition: {type: "spring", stiffness:300, damping:500}
  ...
  return (
    <div 
    className={`hidden md:flex w-63 bg-neutral-950 md:flex-col md:justify-start items-center h-screen fixed md:top-0 ${visible ? "opacity-70": " "}`}>
