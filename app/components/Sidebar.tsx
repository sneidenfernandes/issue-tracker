        ...
        <ul className='text-neutral-400 w-full space-y-3 flex flex-col justify-start mt-[2vh]'>
            <li className='ml-3 flex text-sm bg-neutral-800 w-[90%] rounded py-2 flex-col justify-center text-neutral-300'>
                <div className='ml-2  flex justify-start w-[65%]'>
                    <svg width="20px" height="20px" viewBox="0 0 24 24" stroke-width="1.5" fill="none" xmlns="http://www.w3.org/2000/svg" color="#f1f1f1"><path d="M6 3H3V6" stroke="#f1f1f1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M18 3H21V6" stroke="#f1f1f1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M6 21H3V18" stroke="#f1f1f1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M18 21H21V18" stroke="#f1f1f1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M12.5145 17.6913L16.5145 15.2913C16.8157 15.1106 17 14.7851 17 14.4338V10.5662C17 10.2149 16.8157 9.88942 16.5145 9.7087L12.5145 7.3087C12.1978 7.11869 11.8022 7.11869 11.4855 7.3087L7.4855 9.7087C7.1843 9.88942 7 10.2149 7 10.5662V14.4338C7 14.7851 7.1843 15.1106 7.4855 15.2913L11.4855 17.6913C11.8022 17.8813 12.1978 17.8813 12.5145 17.6913Z" stroke="#f1f1f1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M7.5 10.5L12 12.9995M12 12.9995C12 12.9995 15.7637 10.9492 16.5 10.5M12 12.9995V17.5" stroke="#f1f1f1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                    <p className='ml-3 '><Link href={"/home/dashboard"}>My Issues</Link></p> 
                </div>
            </li>

            <li className='ml-3 flex text-xs hover:bg-neutral-800 w-[90%] rounded py-2 justify-start'>
                <p className='px-4'><Link href={"/home/issues"}>Workspace</Link></p> 
                <svg className='-ml-3 mt-[2px]' width="12px" height="12px" viewBox="0 0 24 24" stroke-width="1.4" fill="none" xmlns="http://www.w3.org/2000/svg" color="#a9a9a9"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.71299 18.6929C8.43273 18.5768 8.25 18.3033 8.25 18V5.99998C8.25 5.69663 8.43273 5.42315 8.71299 5.30707C8.99324 5.19098 9.31583 5.25515 9.53033 5.46965L15.5303 11.4696C15.8232 11.7625 15.8232 12.2374 15.5303 12.5303L9.53033 18.5303C9.31583 18.7448 8.99324 18.809 8.71299 18.6929Z" fill="#a9a9a9"></path></svg>
            </li>

            <li className='ml-3  flex text-xs hover:bg-neutral-800 w-[90%] rounded py-2 flex-col justify-center'>
                <p className='px-4 mb-1'><Link href={"/home/issues"}>Teams</Link></p> 
            </li>
        </ul>
